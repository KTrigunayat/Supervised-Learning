...
def load_and_preprocess_data_decision_tree():
    # Load the dataset
    ...
    model = DecisionTreeClassifier(
        random_state=42,
        max_depth=None,                # Increased depth         # Ensures splits happen only when necessary          # Prevents overfitting      # Helps with class imbalance
    )
...
pipeline, X_test, y_test, y_train = load_and_preprocess_data_decision_tree()
